        ...
        $(function () {
            $('.sortable').sortable({
                ...
                $.ajax({
                    ...
                    error: function (data) {
                        showMessage('Quelque chose s\'est mal passé. Veuillez réessayer.');
                    }
                });
            });
        });
        ...
        <div class="btn-toolbar" role="toolbar">
            <div class="btn-group btn-group-responsive">
                <button data-modal-id='CreateTicket'
                        ...
                        class='loadModal btn btn-success' type="button"><i class="ico-ticket"></i> Créer un ticket
                </button>
            </div>
            @if(false)
                <div class="btn-group btn-group-responsive ">
                ...
                <div class="btn-group btn-group-responsive">
                    <button type="button" class="btn btn-success">
                        <i class="ico-tags"></i> Codes de coupon
                    </button>
                </div>
            @endif
        </div>
        ...
        <div class="row">
            <div class="col-md-3 col-xs-6">
                <div class='order_options'>
                    <span class="event_count">{{$tickets->count()}} événements</span>
                </div>
            </div>
            ...
            @foreach($tickets as $ticket)
                <div id="ticket_{{$ticket->id}}" class="col-md-4 col-sm-6 col-xs-12">
                    <div class="panel panel-success ticket" data-ticket-id="{{$ticket->id}}">
                        ...
                        {{ ($ticket->is_free) ? "GRATUIT" : money($ticket->price, $event->currency) }}
                    </span>
                            </h3>
                        </div>
                            ...
                            <ul class="nav nav-section nav-justified mt5 mb5">
                                ...
                                <li>
                                    <div class="section">
                                        ...
                                        <p class="nm text-muted">Restant</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="section">
                                        ...
                                        <p class="nm text-muted">Revenu</p>
                                    </div>
                                </li>
                            </ul>
                        </div>

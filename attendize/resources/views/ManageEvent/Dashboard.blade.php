...
@section('page_title', '<i class="ico-home2"></i>&nbsp;Tableau de bord des événements')
...
@section('content')
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel">
                        <div class="panel-heading panel-default">
                            <h3 class="panel-title">
                                Les visites de pages d'évenements
                                <span style="color: green; float: right;">
            ...
            <div class="panel panel-success hide">
                ...
                <div class="panel-body">
                    ...
                    <a href="" class="btn-link btn">
                        Modifier la conception de la page d'événement <i class="ico ico-arrow-right3"></i>
                    </a>
                    <a href="" class="btn-link btn">
                        Créer des tickets <i class="ico ico-arrow-right3"></i>
                    </a>
                    <a href="" class="btn-link btn">
                        Code d'intégration du site Web <i class="ico ico-arrow-right3"></i>
                    </a>
                    <a href="" class="btn-link btn">
                        Générer un lien d'affiliation <i class="ico ico-arrow-right3"></i>
                    </a>
                    <a href="" class="btn-link btn">
                        Modifier les frais de l'organisateur <i class="ico ico-arrow-right3"></i>
                    </a>
                </div>
    ...
    <script>
        ...
        if (target_date < now) {
            countdown.innerHTML = 'Cet événement a commencé.';
        } else {
            ...
            function setCountdown() {
                ...
                countdown.innerHTML = (days > 0 ? '<b>' + days + "</b> jours<b> " : '') + (hours > 0 ? hours + " </b>heures<b> " : '') + (minutes > 0 ? minutes + "</b> minutes" : '');
            }
        }

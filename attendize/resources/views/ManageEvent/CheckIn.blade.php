            ...
            <div class="col-md-12">
                <div class="attendee_input_wrap">
                    ...
                    'class' => 'form-control attendee_search',
                            ...
                            'placeholder' => 'Recherche par nom du participant, référence de la commande, référence du participant ... '
                ])  !!}
            ...
            <div class="col-md-12">
                <div class="attendee_list">
                    ...
                    <div style="margin: 10px;" v-if="searchResultsCount == 0 && searchTerm" class="alert alert-info"
                         v-cloak>
                        Aucun participant correspondant au <b>@{{ searchTerm }}</b>
                    </div>
                    ...
                    <ul v-if="searchResultsCount > 0" class="list-group" id="attendee_list" v-cloak>
                        ...
                        >
                        Nom: <b>@{{ attendee.first_name }} @{{ attendee.last_name }} </b> &nbsp; <span v-if="!attendee.is_payment_received" class="label label-danger">Awaiting Payment</span>
                        <br>
                        Réference: <b>@{{ attendee.order_reference + '-' + attendee.reference_index }}</b>
                        <br>
...
<div role="dialog" id="QrModal" class="scannerModal" v-show="showScannerModal" v-cloak>
    <div class="scannerModalContent">
        ...
        <div class="ScanResultMessage">
                    ...
                    <span v-else>
                        <div id="scanning-ellipsis">Scan en cours<span>.</span><span>.</span><span>.</span></div>
                    </span>
        </div>

        ...
        <div class="btn-toolbar" role="toolbar">
            <div class="btn-group btn-group btn-group-responsive">
                ...
                <button class="loadModal btn btn-success" type="button" data-modal-id="CreateQuestion"
                    ...
                    <i class="ico-question"></i> Ajouter une question
                </button>
            </div>

            <div class="btn-group btn-group btn-group-responsive">
                <button type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown">
                    <i class="ico-users"></i> Exporter les réponses <span class="caret"></span>
                </button>
                        ...
                        <table class="table">
                            ...
                            @foreach ($questions as $question)
                                <tr id="question-{{ $question->id }}" data-question-id="{{ $question->id }}">
                                    ...
                                    <td>
                                        <span class="label label-{{ $question->is_enabled ? 'info' : 'warning' }}">{{ $question->is_enabled ? 'Activée' : 'Désactivé' }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-xs btn-primary enableQuestion" href="javascript:void(0);"
                                           ...
                                           data-id="{{ $question->id }}"
                                        >
                                            {{ $question->is_enabled ? 'Activée' : 'Désactivé' }}
                                        </a>
